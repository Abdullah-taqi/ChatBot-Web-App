...
let hello = ["Hello","Hello,How may i help you?","Hello, How are you?"]
let intro = ["I am a Robo, memory 1 terabyte, processor i50DMX, How may i help you?"];
...
function chatbotvoice(message){
    ...
    speech.text = "I dont wanna talk to a kid"
    if(message.includes('who are you')){
        let finalresult = intro[Math.floor(Math.random() * intro.length)];
        speech.text = finalresult;
    }
    if(message.includes('hello')){
        let finalresult = hello[Math.floor(Math.random() * intro.length)];
        speech.text = finalresult;
    }
